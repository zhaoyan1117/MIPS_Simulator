...
void disassemble(inst_t inst)
{
  ...
  case 0x4: // opcode == 0x4 (BEQ)
    printf("beq\t$%d,$%d,%d\n", inst.itype.rs, inst.itype.rt, signextension(inst.itype.imm)*4);
    break;
  ...
  case 0x9: // opcode == 0x9 (ADDIU)
    printf("addiu\t$%d,$%d,%d\n", inst.itype.rt, inst.itype.rs, signextension(inst.itype.imm));
    break;
  ...
  case 0x20: // opcode == 0x20 (LB)
    printf("lb\t$%d,%d($%d)\n", inst.itype.rt, signextension(inst.itype.imm), inst.itype.rs);
    break;
